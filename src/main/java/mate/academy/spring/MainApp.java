...
public class MainApp {
    ...
    public static void main(String[] args) throws SQLException {
        User bora = new User("Sunil", "Bora",
                "suni.bora@example.com", new ArrayList<Book>());
        ...
        User miller = new User("David", "Miller",
                "david.miller@example.com", new ArrayList<Book>());
        ...
        User singh = new User("Sameer", "Singh",
                "sameer.singh@example.com", new ArrayList<Book>());
        ...
        for (User user : usersFromDb) {
            ...
            System.out.println("RentBooks = " + user.getRentBooks());
            System.out.println();
        }
